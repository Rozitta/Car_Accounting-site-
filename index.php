...
?>
    ...
    <div class="wrapper">
        <!-- секция №1 -->
        <section class="car_accounting" id="main">
            <div class="container">
                <div class="title">
                    <h1 class="title__1part ">Постановка на учет</h1>
                    <span class="title__des--tabl">в Москве</span>
                    <div class="title__2part--flex">
                        <span class="title__2part">за</span>
                        <span class="title__2part--size title__2part--size--tabl">90</span>
                        <span class="title__2part title__2part--minutes">минут</span>
                    </div>
                </div>
                <p class="title__des">в Москве</p>
                <p class="provision__block__phone  provision__block__phone--mainPage">+7 925 067-20-68</p>
                <a href="tel:+79250672068" class="provision__block__phone  provision__block__phone--mainPage provision__block__phone--mainPage--click">+7 925 067-20-68</a>
                <!-- цена -->
                <div class="price">
                    <ul class="price__list">
                        <li class="price__items">Стоимость на все услуги единая - 3500
                            <span>&#8381;</span>
                        </li>
                        <li class="price__items price__items--margin">Время на оформление - 90 минут</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="our-work" id="work">
            <div class="container">
                <h2 class="work__style">Как мы работаем?</h2>
                <div class="work">
                    ...
                    <img class="work__rectangle_down" src="img/rectangle_down.png" alt="">
                    <div class="work__items--rectangle">
                    ...
                    <div class="work__items work__items--center">
                        ...
                        <p class="work__items__desc">Звоните нам на
                            <span class="work__items__desc--color"> +7 925 067-20-68</span>
                            <a href="tel:+79250672068" class=" work__items__desc--color work__items__desc--click">+7 925 067-20-68</a> мы уточняем все детали и договариваемся о встрече.
                        </p>
                    </div>
                    <img class="work__rectangle_down" src="img/rectangle_down.png" alt="">
                    <div class="work__items--rectangle">
        ...
        <section class="ourServises">
            <div class="container">
                <h2 class="ourServises__title">Услуги, которые мы предоставляем</h2>
            ...
            ">
                ...
                <div class="ourServise-type">
                    <div class="ourServise-type__block-left">
                        <img class='registration__block__img--down registration__block__img--down__serviseMain' src="./img/serviseBlock2.png" alt="">
                    </div>
                    <div class="ourServise-type__block-right">
            ...
            ">
                ...
                <div class="ourServise-type">
                    <div class="ourServise-type__block-left">
                        <img class='registration__block__img--down registration__block__img--down__serviseMain' src="./img/serviseBlock4.png" alt="">
                    </div>
                    <div class="ourServise-type__block-right">
            ...
            ">
                ...
                <div class="ourServise-type">
                    <div class="ourServise-type__block-left">
                        <img class='registration__block__img--down registration__block__img--down__serviseMain' src="./img/numbers.png" alt="">
                    </div>
                    <div class="ourServise-type__block-right">
            ...
            ">
                ...
                <div class="ourServise-type__team">
                    <div class="ourServise-type__left">
        ...
        <section class="map_conteiner">
            ...
            <div class="map__style">
                <div class="container">
                    <div class="contact">
                        <h2 class="contact__name">Контакты</h2>
                        <p class="contact__street">улица Твардовского, 8 корпус 5, Москва</p>
                        <span class="contact__pfone">+7 925 067-20-68</span>
                    </div>
                </div>
            </div>
        </section>
