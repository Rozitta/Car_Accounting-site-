                ...
                <div class="container">
                    ...
                    <ul class="burger__items">
                        <li class="burger__item">
                            <a class="burger__link" href="index.php">Главная</a>
                        </li>
                        <li class="burger__item">
                            <a class="burger__link" href="about_us.php">О нас</a>
                        </li>
                        <li class=" burger__items--servise ">
                            ...
                            <ul class="submenu-tab">
                                <li class="submenu__items submenu__items-tab">
                                    <a class="submenu__link submenu__link-tab" href="servise_registration.php">Постановка на учет </a>
                                </li>
                                <li class="submenu__items submenu__items-tab">
